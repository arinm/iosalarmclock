# Punctual - App Store listing (v1.0, EN-US)

Character limits: name 30 · subtitle 30 · promo 170 · keywords 100 · description 4000.

## App Name (22/30)
Punctual - Smart Alarm
...
ALWAYS KNOW WHEN IT RINGS
Every alarm shows a live countdown - "Rings in 7h 42m" - updating in real time, even while you're still picking the time. No more mental math at midnight.

A HEADS-UP BEFORE IT RINGS
A quiet notification ahead of each alarm, with a Skip button right on it. Decide from your pillow, before the ringing starts.
...
• Custom sounds - import your own audio for the heads-up and the alarm

Pay how you like: monthly, yearly, or a one-time Lifetime purchase. If you hate subscriptions, Lifetime is yours forever. No rent on an alarm clock.

PRIVATE BY DESIGN
No accounts, no analytics, no tracking. Your alarms never leave your device.

AN HONEST NOTE ON RELIABILITY
No alarm app can guarantee a ring - iOS ultimately decides when alarms fire, and a phone that's off or out of battery can't ring at all. For anything you can't afford to miss, please set a second, independent alarm.
...
## What's New (v1.0)
Welcome to Punctual 1.0 - the smart alarm for iPhone. Skip today, never forget tomorrow.

## Other ASC fields
- Primary category: Utilities · Secondary: Lifestyle
- Age rating: 4+
- Marketing URL: https://punctualalarm.com/
- Support URL: https://punctualalarm.com/support.html
- Privacy Policy URL: https://punctualalarm.com/privacy.html

## Screenshot captions (marketing frames)
1. Skip today. Never forget tomorrow. / The alarm that tells you before it rings.
2. Always know when it rings - A live countdown on every alarm, updating in real time.
3. Set it in seconds
4. Make it yours
